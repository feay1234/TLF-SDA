...
if __name__ == "__main__":
    ...
    if dataset not in ['woz2', 'sim-m', 'sim-r', 'multiwoz21', 'multiwoz22', 'multiwoz23']:
    ...
    for fp in sorted(glob.glob(sys.argv[3])):
        ...
        for slot in slots:
            ...
            if len(sys.argv) == 6 and set_type == "test" and target != "" and target not in slot:
                continue
            elif len(sys.argv) == 6 and set_type != "test" and target != "" and target in slot:
                continue
            # print(set_type, target, len(sys.argv))
...
# python3 metric_bert_dst.py multiwoz21 dataset_config/multiwoz21.json "sigir2_multiwoz21_train_col-desc_v7_e0/pred_res.test*json" train test 2>&1 | tee sigir2_multiwoz21_train_col-desc_v7_e0/eval_pred_test.log
